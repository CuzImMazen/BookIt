...
//       children: [
//         Text(
//           context.ownerloc.selectLocation,
...
//           hint: Text(
//             context.ownerloc.selectGovernorate,
...
class LocationSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final governorates = getGovernorates().where((g) => g != "All").toList();
    final cities = getCities(selectedGovernorate);
      ...
      children: [
        ...
        DropdownButtonFormField<String>(
          ...
          items: governorates
              .map(
                (gov) => DropdownMenuItem(
                  value: gov, // English for backend
                  child: Text(
                    _localizedGovernorate(context, gov),
                    style: theme.textTheme.bodyMedium,
                  ),
                ),
              )
          ...
          items: cities
              .map(
                (city) => DropdownMenuItem(
                  value: city, // English for backend
                  child: Text(
                    _localizedCity(context, selectedGovernorate, city),
                    style: theme.textTheme.bodyMedium,
                  ),
                ),
              )
  ...
  String _localizedGovernorate(BuildContext context, String governorate) {
    switch (governorate) {
      case "Damascus":
